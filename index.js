/**
 * ======================================================
 * ALL IN ONE VIDEO DOWNLOADER - AIO Downloader
 * ======================================================
 * @owner      : Mudasir Hussain
 * @developer  : Mudasir Hussain
 * @creator    : RiiCODE (Original) / Modified by Mudasir Hussain
 * @website    : aio-downloader.com
 * @version    : 2.0.0
 * @description: Download videos from TikTok, YouTube, Facebook, Instagram and more
 * ======================================================
 */
...
║   🔗 API Endpoint: http://localhost:${PORT}/api/download     ║
